...
public:
  ...
  void loadFromBinaryString(const std::string& data);
...
template<class TDescriptor, class F>
void TemplatedVocabulary<TDescriptor, F>::loadFromBinaryString(const std::string& data)
{
  std::istringstream ifs(data, std::ios_base::in | std::ios::binary);
  // ifs.open(filename.c_str(), std::ios_base::in | std::ios::binary);
